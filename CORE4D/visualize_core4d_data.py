...
def process(args):
    ...
    smplx_model = smplx.create(smplx_model_dir, model_type="smplx", gender="neutral", batch_size=1, use_face_contour=False, num_betas=10, num_expression_coeffs=10, ext="pkl", use_pca=True, num_pca_comps=12, flat_hand_mean=True)
